...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4 ">
        ...
        <div>
            <a href="{{ route('setjenweb.menu.create') }}" class="btn btn-success">
                    ...
                    <tbody>
                        @foreach ($menus as $menu)
                            <tr>
                                ...
                                <td class="p-1 text-center">{{ $menu->judul }}</td>
                                <td class="text-center">
                                    <a href="{{ route('setjenweb.menu.edit', $menu->id) }}"
                                        class="btn btn-primary ">
                                        <i class="ri-edit-2-line"></i> Edit
                                    </a>
                                    <form action="{{ route('setjenweb.menu.destroy', $menu->id) }}"
