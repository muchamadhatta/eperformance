...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="main-title mb-0">Edit Berita</h4>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                ...
                <form action="{{ route('setjenweb.berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        ...
                        @if ($berita->thumbnail)
                            <br>
                            <img class="mb-3 border " src="{{ asset($berita->thumbnail) }}" alt="Gambar"
                                style="max-height: 100px;">
                            <br>
                            <a href="{{ route('setjenweb.berita.deleteThumbnail', ['id' => $berita->id, 'jenis' => 'img']) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" id="judul" name="judul"
                            value="{{ $berita->judul }}" placeholder="Masukan Judul">
                    </div>
                    <div class="mb-3">
                        <label for="tanggal" class="form-label fw-bold">Tanggal</label>
                        <input id="datepicker5" type="text" class="form-control w-50 " id="tanggal" name="tanggal"
                            value="{{ date('m/d/Y', strtotime($berita->tanggal)) }}" placeholder="Pilih Tanggal">
                    </div>
                    <div class="mb-3  w-50">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" id="slug" name="slug"
                            value="{{ $berita->slug }}" placeholder="Masukan Tempat">
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="form-control w-50" id="status_publikasi" name="status_publikasi">
                            <option value="1" {{ $berita->status_publikasi == 1 ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ $berita->status_publikasi == 0 ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="dibaca" class="form-label fw-bold">Dibaca</label>
                        <input disabled type="text" class="form-control w-50" id="dibaca" name="dibaca"
                            value="{{ $berita->dibaca }}" >
                    </div>
