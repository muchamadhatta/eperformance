...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="main-title mb-0">Tambah Komentar</h4>
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                ...
                <form action="{{ route('setjenweb.komentar.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control w-50" name="komentar" id="komentar" cols="30" rows="3"></textarea>
                    </div>
