...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4 ">
        <div>
            ...
            <h4 class="main-title mb-0">Daftar Pegawai</h4>
        </div>
        <div>
            <a href="{{ route('setjenweb.pegawai.create') }}" class="btn btn-success">
                <i class="ri-pencil-line"></i> Tambah Pegawai
            </a>
        </div>
    </div>
                    ...
                    <tbody>
                        @foreach ($pegawais as $pegawai)
                            <tr>
                                ...
                                <td class="p-1 text-center">{{ $pegawai->nama }}</td>
                                <td class="text-center">
                                    <a href="{{ route('setjenweb.pegawai.edit', $pegawai->id) }}"
                                        class="btn btn-primary ">
                                        <i class="ri-edit-2-line"></i> Edit
                                    </a>
                                    <form action="{{ route('setjenweb.pegawai.destroy', $pegawai->id) }}"
