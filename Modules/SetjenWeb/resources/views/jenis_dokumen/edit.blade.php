...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="main-title mb-0">Edit Jenis Dokumen</h4>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <div class="mb-3">
                <form action="{{ route('setjenweb.jenis_dokumen.update', $jenis_dokumen->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-row gap-2">
                            <input type="text" class="form-control w-50" id="jenis_dokumen" name="jenis_dokumen"
                                placeholder="Masukan Jenis Dokumen" value="{{ $jenis_dokumen->jenis_dokumen }}">
