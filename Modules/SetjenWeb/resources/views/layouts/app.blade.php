...
<head>
    ...
    <title>{{ $nama_website }} | DPR RI</title>
    ...
    <!-- Template CSS -->
    <link rel="stylesheet" href="{{ asset('theme/admin-dashbyte/dist/lib/select2/css/select2.min.css ') }}">
    ...
    <script src="{{ asset('theme/admin-dashbyte/dist/lib/select2/js/select2.full.min.js ') }}"></script>
...
<body id="konten">
    @include('setjenweb::layouts.sidebar')
    @include('setjenweb::layouts.header')

    <div class="main main-app p-3 p-lg-4">
        @yield('content')
        @include('setjenweb::layouts.footer')
    </div>
