            ...
            <div class="mb-3">
                <form action="{{ route('ruu_riwayat.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-row gap-2">
                            <select class="form-select w-50" name="tahun" id="tahun" required>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            checkboxes.forEach(function(checkbox) {
                checkbox.addEventListener('change', function() {
                    ...
                    const inputs = document.querySelectorAll('input[name^="no_urut_prioritas[' + index + ']"], input[name^="judul_ruu_prioritas[' + index + ']"], input[name^="pengusul_prioritas[' + index + ']"]');
