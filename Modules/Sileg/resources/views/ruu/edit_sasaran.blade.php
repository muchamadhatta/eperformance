...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="main-title mb-0">Edit Sasaran</h4>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <div class="mb-3">
                <form action="{{ route('ruu.update_ruu_deskripsi_konsepsi_sasaran', $ruu_deskripsi_konsepsi->id) }}" method="POST"
                    ...
                    <div class="mb-3  w-50">
                        ...
                        <div id="editor-container" class="ht-250">
                            {{ $ruu_deskripsi_konsepsi->sasaran }}
                        </div>
                        <input type="hidden" id="editor_input" name="sasaran">
                    </div>
