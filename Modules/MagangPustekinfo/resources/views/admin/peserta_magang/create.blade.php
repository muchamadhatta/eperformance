...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div>
        <ol class="breadcrumb fs-sm mb-1">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tambah Peserta Magang</li>
        </ol>
        <h4 class="main-title mb-0">Tambah Peserta Magang</h4>
    </div>
</div>

<div class="card">
    <div class="card-body">
        <form action="{{ route('magangpustekinfo.admin.peserta_magang.store') }}" method="POST">
            @csrf
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('nomor_handphone') is-invalid @enderror" 
                           id="nomor_handphone" name="nomor_handphone" value="{{ old('nomor_handphone') }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('username_github') is-invalid @enderror" 
                           id="username_github" name="username_github" value="{{ old('username_github') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('tingkat_pendidikan') is-invalid @enderror" 
                        ...
                        <option value="Magang" {{ old('tingkat_pendidikan') == 'Magang' ? 'selected' : '' }}>Magang (Kuliah)</option>
                        <option value="PKL" {{ old('tingkat_pendidikan') == 'PKL' ? 'selected' : '' }}>PKL (SMA/SMK)</option>
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('nama_sekolah') is-invalid @enderror" 
                        ...
                        @if(old('nama_sekolah'))
                            <option value="{{ old('nama_sekolah') }}" selected>{{ old('nama_sekolah') }}</option>
                        @endif
                    </select>
                    @error('nama_sekolah')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="text-muted" id="hint_institusi">Pilih jenis program terlebih dahulu</small>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('jurusan') is-invalid @enderror" 
                        ...
                        @if(old('jurusan'))
                            <option value="{{ old('jurusan') }}" selected>{{ old('jurusan') }}</option>
                        @endif
                    </select>
                    @error('jurusan')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('semester') is-invalid @enderror" 
                           id="semester" name="semester" value="{{ old('semester') }}" min="1" max="14">
                    @error('semester')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('jenis_magang') is-invalid @enderror" 
                        ...
                        <option value="Hub" {{ old('jenis_magang') == 'Hub' ? 'selected' : '' }}>Hub (Kerjasama Institusi)</option>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('kategori_project') is-invalid @enderror" 
                        ...
                        <option value="Aplikasi" {{ old('kategori_project') == 'Aplikasi' ? 'selected' : '' }}>Aplikasi</option>
                        <option value="Data Analitik" {{ old('kategori_project') == 'Data Analitik' ? 'selected' : '' }}>Data Analitik</option>
                        <option value="Infrastruktur" {{ old('kategori_project') == 'Infrastruktur' ? 'selected' : '' }}>Infrastruktur</option>
                        <option value="Keamanan" {{ old('kategori_project') == 'Keamanan' ? 'selected' : '' }}>Keamanan</option>
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" 
                        ...
                        <option value="Permohonan" {{ old('status', 'Permohonan') == 'Permohonan' ? 'selected' : '' }}>Permohonan</option>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('tugas') is-invalid @enderror" 
                              id="tugas" name="tugas" rows="3" required>{{ old('tugas') }}</textarea>
                    @error('tugas')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('mentor') is-invalid @enderror" 
                              id="mentor" name="mentor" rows="3">{{ old('mentor') }}</textarea>
                    @error('mentor')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#nama_sekolah').select2({
            theme: 'bootstrap-5',
            placeholder: 'Pilih jenis program terlebih dahulu',
            allowClear: true,
        ...
        var oldTingkatPendidikan = "{{ old('tingkat_pendidikan') }}";
        
        if(oldTingkatPendidikan){
            $('#tingkat_pendidikan').trigger('change');
        }
    });
</script>
@endpush
